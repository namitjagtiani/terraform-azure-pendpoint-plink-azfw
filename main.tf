...
resource "azurerm_resource_group_template_deployment" "temp" {
  ...
  parameters_content = jsonencode({
    ...
    producerSubId               = { value = "/subscriptions/${var.pendpoint_sub_id}/resourceGroups/pendpoint-rg/providers/Microsoft.Network/virtualNetworks/plink-vnet/subnets/plink-subnet" }
  })
  depends_on = [
